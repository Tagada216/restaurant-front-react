...
import CustPageList from './pages/CustPageList';
import DishesPageList from './pages/DishesPageList';
import PaymentPageList from './pages/PaymentPageList';
import OrderDetailsPage from './pages/OrderDetailsPage';
import CustDetailsPage from './pages/CustDetailsPage';
import DishesDetailsPage from './pages/DishesDetailsPage';
function App() {
  ...
  return (
   <div>
     <Router>
            {/*  Défénitions des routes  */}
            <Switch>
                <Route path="/orders/:id" component={OrderDetailsPage}/>
                <Route path="/dishes/:id" component={DishesDetailsPage}/>
                <Route path="/cust/:id" component={CustDetailsPage} />
                <Route path="/payment" component={PaymentPageList}/>
                <Route path="/dishes" component={DishesPageList}/>
                <Route path="/cust" component={CustPageList}/>
                <Route path="/orders" component={OrderPageList}/>
          ...
          <nav id="app-nav-main" className="app-nav app-nav-main flex-grow-1">
            ...
            >
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="/cust">
                  <span className="nav-icon">
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="/dishes">
                  ...
                  <span className="nav-link-text">Plats et Boisson</span>
                </NavLink>
              </li>
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="/payment">
                  ...
                  <span className="nav-link-text">Moyens de paiement</span>
                </NavLink>
              </li>
            </ul>
          </nav>
