...
import OrderList from "./composants/OrderList";
import DishesList from "./composants/DishesList";
...
function App() {
  ...
  const [orders,] = useState([
    {code: "000001", status: "Finish", date:"06/07/2021 12:04" },
    {code: "000002", status: "Finish", date:"06/07/2021 12:34" },
    {code: "000003", status: "Cooking", date:"06/07/2021 12:42" },
    {code: "000004", status: "Pending", date:"06/07/2021 13:05" }
  ])

  //----------------Dishes-------------------------
  const [dishes,] = useState([
    {name: "4 Fromages", description: "Mozzarella, chèvre, Gorgonzolla, emental", price:"12.50" },
    {name: "Pizza Welsh", description: "Cheddar à la biére, jambon, base  tomate", price:"14.50" },
    {name: "Pizza Saumon", description: "Base créme, saumon, Aneth", price:"5.50" },
    {name: "Mojito", description: "Rhum, Perrier, citron, menthe", price:"5.50" },
    {name: "Coca-Cola", description: "Wavin Flag", price:"3.50" }
  ])

  //---------------Cust-------------
  const [custs,]= useState([
    {lastname: "Del", firstname: "Nicolas", email:"nicolas@email.fr", address:"2 rue des fleurs, Paris", phone:"06 60 60 06 06" },
    {lastname: "Dupont", firstname: "Fred", email:"fred@email.com", address:"19 rue de l'égalité, Douai", phone:"06 60 60 06 07" },
    {lastname: "Vanpopu", firstname: "Chris", email:"cricridu62@email.fr", address:"77, rue de voitures, Lens", phone:"07 60 60 06 06" }
  ])
          ...
          <div className="app-content pt-3 p-md-3 p-lg-4">
            <div className="container-xl">
              <div className="row g-3 mb-4 align-items-center justify-content-between">
                <div className="col-auto">
                  <h1 className="app-page-title mb-0">Tableaux récapitulatif</h1>
                </div>
                <div className="col-auto">
                    ...
                    <div className="table-responsive">
                      <table className="table app-table-hover mb-0 text-left">
                        ...
                        <tbody>
                          {
                            orders.map(order => {
                              return <OrderList code={order.code} status={order.status} date={order.date}/>
                            })
                          }
                        </tbody>
                      </table>
                      ...
                      <table className="table app-table-hover mb-0 text-left">
                        <thead>
                          <tr>
                            ...
                            <th className="cell">Desciption</th>
                        ...
                        <tbody>
                          {
                            dishes.map(dishe => {
                              return <DishesList name={dishe.name} description={dishe.description} price={dishe.price}/>
                            })
                          }
                        </tbody>
                      </table>
                    ...
                    <div className="table-responsive">
                      <table className="table app-table-hover mb-0 text-left">
                        ...
                        <tbody>
                          {
                            custs.map(cust =>{
                              return <CustList lastname={cust.lastname} firstname={cust.firstname} email={cust.email} address={cust.address} phone={cust.phone}/>
                            })
                          }
                        </tbody>
                      </table>
