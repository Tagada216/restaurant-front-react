              ...
              <div className="container-xl">
                <div className="row g-3 mb-4 align-items-center justify-content-between">
                  <div className="col-auto">
                    <h1 className="app-page-title mb-0">Clients</h1>
                  </div>
                  <div className="col-auto">
                        ...
                        <table className="table app-table-hover mb-0 text-left">
                          ...
                          <tbody>
                          {
                                ...
                                custList.map(cust => {
                                  return  (
                                  <tr key={cust.id}>
                                      <td className="cell">{cust.lastname}</td>
                                      <td className="cell"> {cust.firstname}</td>
                                      <td className="cell">
                                          <span>{cust.email}</span>
                                      </td>
                                      <td className="cell">
                                          <Link className="btn-sm app-btn-secondary" to={"/cust/"+cust.id}>
                                                  Voir
                                          </Link>
                                      </td>
                                  </tr>
