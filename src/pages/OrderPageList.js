...
function OrderPageList(){
    ...
    function setColor(){
        const currOrders = orderList;
        currOrders.forEach(el =>{
            console.log("Les éléments",el)
        })
        // switch () {
        //     case value:
              ...
              <div className="container-xl">
                <div className="row g-3 mb-4 align-items-center justify-content-between">
                  <div className="col-auto">
                    <h1 className="app-page-title mb-0">Commandes</h1>
                  </div>
                  <div className="col-auto">
                          ...
                          <tbody>
                            {
                              ...
                              orderList.map(order => {
                                return  (
                                <tr key={order.id}>
                                    <td className="cell">#{order.code}</td>
                                    <td className="cell"><span className="badge bg-secondary"> {order.status}</span></td>
                                    <td className="cell">
                                        <span>{order.date}</span>
                                    </td>
                                    <td className="cell">
                                        <Link className="btn-sm app-btn-secondary" to={"/orders/"+order.id}>
                                                Voir
                                        </Link>
                                    </td>
                                </tr>
