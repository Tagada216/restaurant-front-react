...
function DishesPageList(){
    const [dishesList, setDishesList] = useState([]);

    useEffect(() => {
        axios.get('http://localhost:3030/dishes')
        .then(res => {
                        ...
                        <table className="table app-table-hover mb-0 text-left">
                          ...
                          <tbody>
                          {
                                ...
                                dishesList.map(dish => {
                                  return  (
                                  <tr key={dish.id}>
                                      <td className="cell">{dish.name}</td>
                                      <td className="cell"> {dish.description}</td>
                                      <td className="cell">
                                          <strong>{dish.price} €</strong>
                                      </td>
                                      <td className="cell">
                                          <Link className="btn-sm app-btn-secondary" to={"/dishes/"+dish.id}>
                                                  Voir
                                          </Link>
                                      </td>
                                  </tr>
